...
export const StyledButton = styled.button`
 background: linear-gradient(168deg, rgba(69,5,250,1) 0%, rgba(84,43,200,1) 63%);
...
function App() {
  ...
  const [feedback, setFeedback] = useState(`Click Purchase to mint your NFT.`${CONFIG.MAX_SUPPLY});
